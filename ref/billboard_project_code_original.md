# Billboard Eye Tracker - Full Project Source
...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('yolov8n.pt', '.'), ('scripts', 'scripts'), ('C:\\ProgramData\\miniconda3\\envs\\billboard\\lib\\site-packages\\mediapipe\\modules', 'mediapipe\\modules')],
    hiddenimports=[],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
...
## Path: `billboard_project_code.md`
```

```

## Path: `export_project.py`
```python
import os

project_dir = r"c:\Magang\Billboard-Eye-Tracker"
output_md = r"c:\Magang\Billboard-Eye-Tracker\billboard_project_code.md"

ignores = ['node_modules', '.git', 'build', 'dist', 'output', 'resources', '.vscode', '.idea', '__pycache__']
ignore_exts = ('.exe', '.pt', '.png', '.jpg', '.mp4', '.zip', '.pyc', '.dll', '.bin', '.db')

with open(output_md, 'w', encoding='utf-8') as f:
    f.write("# Billboard Eye Tracker - Full Project Source\n\n")
    ...
    for root, dirs, files in os.walk(project_dir):
        ...
        for file in files:
            ...
            try:
                ...
                # Setup syntax highlight markdown
                ext = file.split('.')[-1]
                lang_map = {'py':'python', 'js':'javascript', 'jsx':'javascript', 'css':'css', 'html':'html', 'json':'json', 'yml':'yaml'}
                ...
                # Pastikan ada newline sebelum tutup markdown tag
                if not content.endswith('\n'):
                    f.write('\n')
                    
                f.write("```\n\n")
            except Exception:
                # Abaikan file yang bukan text (binary/error unicode)
                pass

print(f"File markdown berhasil dibuat di: {output_md}")
```
...
if getattr(sys, 'frozen', False):
    # Running as compiled exe — data files are in sys._MEIPASS
    BASE_DIR = Path(sys._MEIPASS)
    # Output CSV ke folder di samping exe, bukan di dalam bundle
...
def main():
    ...
    try:
        ...
        send({"type": "error", "message": f"Backend error: {exc}\n{tb}"})
...
## Path: `billboard-fe\.editorconfig`
```
root = true
...
## Path: `billboard-fe\.prettierignore`
```
out
dist
pnpm-lock.yaml
...
## Path: `billboard-fe\.prettierrc.yaml`
```
singleQuote: true
semi: false
printWidth: 100
...
## Path: `billboard-fe\electron-builder.yml`
```yaml
appId: com.billboard.eyetracker
...
extraResources:
  - from: resources/billboard_backend
    ...
    filter:
      - "**/*"
win:
  executableName: billboard-eye-tracker
nsis:
...
## Path: `billboard-fe\electron.vite.config.mjs`
```
...
## Path: `billboard-fe\eslint.config.mjs`
```
...
## Path: `billboard-fe\package-lock.json`
```json
{
  "name": "billboard-fe",
  "version": "1.0.0",
  ...
  "packages": {
    ...
    "node_modules/@electron-toolkit/eslint-config": {
      "version": "2.1.0",
      "resolved": "https://registry.npmjs.org/@electron-toolkit/eslint-config/-/eslint-config-2.1.0.tgz",
      "integrity": "sha512-F/r45x5wDHs8r2RSkXwcrMYo9X4lkc/W+ZTlWzOzjXn7ncirMqVo256BCAogeNBWIxd24ePsSwmJXELiQZUZUg==",
      "dev": true,
      "license": "MIT",
      "dependencies": {
        "@eslint/js": "^9.24.0",
...
## Path: `billboard-fe\package.json`
```json
{
  "name": "billboard-fe",
  "version": "1.0.0",
...
## Path: `billboard-fe\out\main\index.js`
```javascript
"use strict";
...
const MAIN_PY = path.join(electron.app.getAppPath(), "..", "main.py");
const BACKEND_EXE = electron.app.isPackaged ? path.join(process.resourcesPath, "billboard_backend", "billboard_backend.exe") : null;
...
function startPython(source, win) {
  ...
  const cmd = electron.app.isPackaged ? BACKEND_EXE : PYTHON_DEV;
  const args = electron.app.isPackaged ? [] : ["-u", MAIN_PY];
  if (source !== void 0 && source !== null) args.push(String(source));
  const cwd = electron.app.isPackaged ? path.join(process.resourcesPath, "billboard_backend") : path.join(electron.app.getAppPath(), "..");
  console.log("[startPython]", cmd, args.join(" "), "| cwd:", cwd);
  pyProcess = child_process.spawn(cmd, args, { cwd, env: { ...process.env } });
...
function setupIPC(win) {
  electron.ipcMain.handle("start-webcam", () => startPython(0, win));
  electron.ipcMain.handle("stop-pipeline", () => stopPython());
  electron.ipcMain.handle("start-video", async () => {
...
electron.app.whenReady().then(() => {
  utils.electronApp.setAppUserModelId("com.billboard.eyetracker");
...
## Path: `billboard-fe\out\preload\index.js`
```javascript
"use strict";
const electron = require("electron");
...
electron.contextBridge.exposeInMainWorld("api", {
  startWebcam: () => electron.ipcRenderer.invoke("start-webcam"),
  startVideo: () => electron.ipcRenderer.invoke("start-video"),
  stopPipeline: () => electron.ipcRenderer.invoke("stop-pipeline"),
  onMessage: (cb) => electron.ipcRenderer.on("py-message", (_e, msg) => cb(msg)),
  offMessage: () => electron.ipcRenderer.removeAllListeners("py-message")
});
```

## Path: `billboard-fe\out\renderer\index.html`
```html
<!doctype html>
<html>
  <head>
    ...
    />
    <script type="module" crossorigin src="./assets/index-DDRQ5X4Z.js"></script>
    <link rel="stylesheet" crossorigin href="./assets/index-Ce8pNrX3.css">
  </head>
...
## Path: `billboard-fe\out\renderer\assets\index-Ce8pNrX3.css`
```css
/* ── reset & base ─────────────────────────────────────────────────────── */
...
.btn-webcam   { background: var(--accent); color: #0f1117; }
.btn-upload   { background: var(--yellow); color: #0f1117; }
...
/* ── CSV table ───────────────────────────────────────────────────────── */
.csv-section { flex: 1; display: flex; flex-direction: column; min-height: 0; }
...
## Path: `billboard-fe\out\renderer\assets\index-DDRQ5X4Z.js`
```javascript
...
function StatCard({ value, label, color }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `stat-val ${color}`, children: value }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stat-label", children: label })
  ] });
}
function StatusDot({ state }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `dot dot-${state}` });
}
function App() {
  const [status, setStatus] = reactExports.useState("idle");
  const [sourceLabel, setSourceLabel] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "logo", children: [
        "Billboard ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Eye Tracker" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "btn-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-webcam", onClick: handleWebcam, disabled: isRunning, children: "▶ Live Webcam" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-upload", onClick: handleUpload, disabled: isRunning, children: "⬆ Upload Video" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn btn-stop", onClick: handleStop, disabled: !isRunning, children: "■ Stop" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "video-panel", children: imgSrc ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { ref: imgRef, src: imgSrc, alt: "feed", className: "video-feed" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "placeholder", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M16 3l-4 4-4-4" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Pilih mode Live Webcam atau Upload Video" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "sidebar", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "Status" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-row", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatusDot, { state: dotState }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: statusLabel })
          ] }),
          sourceLabel && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "source-label", children: [
            "Sumber: ",
            sourceLabel
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "Statistik interval ini" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-grid", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { value: stats.active_people, label: "Di frame", color: "cyan" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { value: stats.people_passing, label: "Total lewat", color: "yellow" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { value: stats.watching_now, label: "Lihat sekarang", color: "green" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { value: stats.people_watching, label: "Total lihat", color: "green" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flush-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "section-title", style: { marginBottom: 0 }, children: "Flush CSV dalam" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flush-time", children: [
              remMin,
              ":",
              remS
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bar-track", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bar-fill", style: { width: barPct + "%" } }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "csv-section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "Log CSV" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "csv-table-wrap", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "csv-table", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Waktu" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Lewat" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Lihat" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: csvRows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 3, className: "empty", children: "Belum ada data" }) }) : csvRows.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.timestamp?.slice(11) ?? "-" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.people_passing }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.people_watching })
            ] }, i)) })
          ] }) })
        ] })
      ] })
...
## Path: `billboard-fe\src\main\index.js`
```javascript
...
## Path: `billboard-fe\src\preload\index.js`
```javascript
...
## Path: `billboard-fe\src\renderer\index.html`
```html
<!doctype html>
<html>
  <head>
...
## Path: `billboard-fe\src\renderer\src\App.jsx`
```javascript
...
## Path: `billboard-fe\src\renderer\src\main.jsx`
```javascript
...
## Path: `billboard-fe\src\renderer\src\assets\base.css`
```css
:root {
  --ev-c-white: #ffffff;
...
## Path: `billboard-fe\src\renderer\src\assets\electron.svg`
```
...
## Path: `billboard-fe\src\renderer\src\assets\main.css`
```css
/* ── reset & base ─────────────────────────────────────────────────────── */
*, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
...
## Path: `billboard-fe\src\renderer\src\assets\wavy-lines.svg`
```
...
## Path: `billboard-fe\src\renderer\src\components\Versions.jsx`
```javascript
